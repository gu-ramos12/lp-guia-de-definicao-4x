...
const slides = [
  ...
  {
    src: "/images/coach/coach2.png",
    alt: "Quem é Rodrigo Brasileiro - História e Motivação",
  },
  {
    src: "/images/coach/coach3.png",
    alt: "Formação Acadêmica de Rodrigo Brasileiro",
  },
  {
    src: "/images/coach/coach4.png",
    alt: "Formação Internacional - Certificação de Treinador nos Estados Unidos",
  },
  {
    src: "/images/coach/coach5.png",
    alt: "Vivência no Esporte - Competições Men's Physique",
  },
  {
    src: "/images/coach/coach6.png",
    alt: "Meu Estilo de Trabalho - Nutrição Prática e Personalizada",
  },
  {
    src: "/images/coach/coach7.png",
    alt: "Treino Individualizado - Essencial para melhores resultados",
  },
  {
    src: "/images/coach/coach8.png",
    alt: "Venha fazer parte do meu time - Atendimento presencial e online",
  },
];
