...
const transformations = [
  {
    src: "/images/transformations/transformation1.png",
    alt: "Transformação Real - Antes e Depois",
    name: "Aluno do RB Team",
  },
  {
    src: "/images/transformations/transformation2.png",
    alt: "Transformação Real - Antes e Depois",
    name: "Aluna do RB Team",
  },
  {
    src: "/images/transformations/transformation3.png",
    alt: "Transformação Real - Antes e Depois",
    name: "Aluna do RB Team",
  },
  {
    src: "/images/transformations/transformation4.png",
    alt: "Transformação Real - Antes e Depois",
    name: "Aluno do RB Team",
  },
  {
    src: "/images/transformations/transformation5.png",
    alt: "Transformação Real - Antes e Depois",
    name: "Aluno do RB Team",
  },
  {
    src: "/images/transformations/transformation6.png",
    alt: "Transformação Real - Antes e Depois",
    name: "Aluno do RB Team",
  },
  {
    src: "/images/transformations/transformation7.png",
    alt: "Transformação Real - Antes e Depois",
    name: "Aluna do RB Team",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-semibold">
            Mais de 500 transformações reais seguindo o Guia de Definição 4X
          </p>
        </div>
