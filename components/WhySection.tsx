...
const features = [
  ...
  },
  {
    icon: "🎯",
    title: "Guia completo",
    description: "Treinos + dietas práticos, passo a passo, para você finalmente alcançar seu objetivo."
  },
  {
    icon: "⏱️",
    title: "Apenas alguns minutos por dia",
    description: "Protocolos eficientes que cabem na sua rotina mais corrida."
  },
  {
    icon: "🏅",
    title: "Método comprovado",
    description: "+500 casos de sucesso acompanhados ao longo de 7 anos."
  },
  {
    icon: "🎧",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            Não é apenas mais um guia. É um sistema completo baseado em ciência e praticidade.
          </p>
        </div>
