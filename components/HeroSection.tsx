      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <h1 className="text-6xl md:text-8xl font-black leading-tight tracking-tight">
            ...
            <span className="bg-gradient-to-r from-white via-gray-100 to-green-100 bg-clip-text text-transparent">
              4X
            </span>
          </h1>
          ...
          <div className="space-y-6">
            <p className="text-3xl md:text-4xl font-bold text-white leading-tight">
              Acelere seu emagrecimento e definição muscular em 
              <span className="text-green-400"> 4X menos tempo</span>
            </p>
            <p className="text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
              O método aplicado e comprovado que já transformou <strong className="text-green-400">centenas de pessoas</strong> e vai revolucionar seus resultados de forma definitiva.
            </p>
          </div>
